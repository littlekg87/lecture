...
> ## ⛔ GIS 실습 지도 파일은 외부로 유출하지 마세요
>
> `data/gis/` 의 **조선 팔도 경계 셰이프파일(`adm_do.*`)** 은
> **한국학중앙연구원 김현종 교수님께서 본 강의를 위해 특별히 제공해 주신 자료**입니다.
>
> **본 강의 실습 목적으로만** 사용하실 수 있으며,
> 제3자 전달·외부 재배포·강의 외 사용은 **저작권 이용 원칙에 위배됩니다.**
> 실습 후에는 개인적으로 보관하지 마시고 삭제해 주세요.
>
> 자세한 내용 → **[data/gis/README.md](data/gis/README.md)**
...
└── data/          실습 데이터
    ...
    ├── gis/             조선 팔도 지도(셰이프파일) + 팔도별 통계  ⛔ 이용 제한 있음
    └── network/         비변사 관원 네트워크
```
...
- **조선 팔도 경계 지도** — ⛔ **한국학중앙연구원 김현종 교수 제공**
  본 강의 실습에 한해 이용이 허락된 자료입니다.
  외부 유출·재배포·강의 외 사용은 저작권 이용 원칙에 위배됩니다.
  → [이용 제한 안내](data/gis/README.md)
- **김상헌 상소문** — 『인조실록』
